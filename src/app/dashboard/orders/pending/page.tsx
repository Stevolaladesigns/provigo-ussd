...
import { RefreshCw, ChevronLeft, ChevronRight, Search, Clock, Eye } from 'lucide-react';
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {paginatedOrders.length === 0 ? (
                                <tr><td colSpan={8} className="text-center py-12 text-gray-400 text-sm">No pending orders found</td></tr>
                            ) : (
